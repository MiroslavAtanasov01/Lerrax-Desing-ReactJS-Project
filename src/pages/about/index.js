        ...
        <PageLayout>
            <div className={styles.container}>
                ...
                <div className={styles.text}>
                    <p>In 2012, we started Lerrax Design with a vision - to make a million homes beautiful.
                ...
                And our homes are just one of the many canvases we have at our disposal.</p>
                    ...
                    <p>Today, we understand that we’re here not just to sell well-designed products. We’re
                ...
                <div className={styles.text}>
                    <p><b>Customer Obsession</b>: Customers are at the center of whatever we do at Lerrax Design.
                ...
                interaction.We aim to set the global benchmark for customer happiness scores.</p>
                    ...
                    <p><b>Honesty & Transparency</b>: We are honest, ethical, and trustworthy in the way we
                ...
                make mistakes, we are honest and upfront about owning up to them.</p>
                    ...
                    <p> <b>Stepping Up</b>: We take charge, go the extra mile, and think differently to find
                    innovative solutions. When in doubt, we push ourselves harder to solve newer
                    challenges and get better solutions</p>

                    <p><b>Efficiency</b>: We are here to build a long-term sustainable business. We aim to do
